...
@section('main-content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="/master-data/users/edit/{{ $thisUser->id }}" method="post">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-6">
                                            ...
                                            <div class="col-12 col-md-5 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name"
                                                        placeholder="Name" value="{{ $thisUser->name }}">
                                                </div>
                                                @error('name')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control" id="email"
                                                        placeholder="Email" value="{{ $thisUser->email }}">
                                                </div>
                                                @error('email')
                                                    ...
                                                    <select id="role" name="role" class="form-control">
                                                        @foreach ($roles as $role)
                                                            <option value="{{ $role->id }}"
                                                                @if ($role->id == $thisUser->role) selected @endif>
                                                                {{ $role->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input"
                                                                @if ($thisUser->status == 'active') checked @endIf
                                                                type="radio" name="status" id="status-active"
                                                                value="active">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input"
                                                                @if ($thisUser->status == 'inactive') checked @endIf
                                                                type="radio" name="status" id="status-inactive"
                                                                value="inactive">
                                                            <label class="form-check-label"
                                            ...
                                            <div class="col-12 col-md-5 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" name="old_password"
                                                        id="old_password" placeholder="Old Password" autocomplete="false">
                                                </div>
                                                @error('old_password')
                                                    <div id="old_password" class="form-text text-danger error my-3">
                                                        {{ $message }}
                                                    </div>
                                                @enderror
                                                <div class="form-group">
