        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body px-4">
                    <form action="/master-data/groups/edit/{{ $group->id }}" method="post">
                        @csrf
                        @method('POST')
                        <div class="row py-4">
                            <div class="col-12 col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="description" rows="5" placeholder="Description">{{ $group->description }}</textarea>
                                </div>
                                @error('description')
